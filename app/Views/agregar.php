...
<body>
  <div class="login-box">
    ...
    <form action="<?php echo base_url('insertar'); ?>" method="POST">
      <div class="user-box">
        <input type="number" hidden name="idConductor">
        <input type="number" class="form-control" id="cedula_cli" name="cedula_cli"  required aria-describedby="emailHelp">
        <label >Cedula</label>
      </div>
      <div class="user-box">
        <input type="text" id="nombre_cli" name="nombre_cli"  required aria-describedby="emailHelp">
        <label >Nombre</label>
    </div>
    <div class="user-box">
        <input type="text" class="form-control" id="genero_cli" name="genero_cli" required aria-describedby="emailHelp">
        <label >Telefono</label>
    </div>
    <div class="user-box">
        <input type="number" class="form-control" id="edad_cli" name="edad_cli" required aria-describedby="emailHelp" >
        <label >Edad</label>
    </div>
