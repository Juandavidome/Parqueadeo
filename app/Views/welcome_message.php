...
.header {
  position:relative;
  text-align:center;
  background: -webkit-linear-gradient(to right, #6388ad, #6388ad);
  background: linear-gradient(to right, #6388ad, #6388ad);
  color:white;
}
.logo {
  width:50px;
...
<body >
        ...
        <div class="content flex">
            <p>El mejor PARQUEADERO del pais</p>
        </div>
</body>
